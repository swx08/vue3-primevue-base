...
import Collapsed from "@/components/layout/header/component/collapsed/Index.vue";
import HeaderRight from "@/components/layout/header/component/right/Index.vue";
